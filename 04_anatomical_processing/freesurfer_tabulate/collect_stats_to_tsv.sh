...
singularity_cmd="singularity exec --containall --writable-tmpfs -B ${SUBJECTS_DIR} -B ${annots_dir} -B ${license}:/opt/freesurfer/license.txt ${fmriprep_sif}"
...
parcs="AAL CC200 CC400 glasser gordon333dil HOCPATh25 Juelich PALS_B12_Brodmann Schaefer2018_100Parcels_17Networks_order Schaefer2018_100Parcels_7Networks_order Schaefer2018_400Parcels_17Networks_order Schaefer2018_400Parcels_7Networks_order 400Parcels_Kong2022_17Networks Slab Yeo2011_17Networks_N1000 Yeo2011_7Networks_N1000"
...
#    ${singularity_cmd} recon-all -s ${subject_id} -qcache -measure pial_lgi
     recon-all -s ${subject_id} -qcache -measure pial_lgi
fi
...
mv ${SUBJECTS_DIR}/*brainmeasures.* ${subject_fs}/
